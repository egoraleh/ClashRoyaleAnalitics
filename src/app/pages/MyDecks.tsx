...
const decks = [
  {
    ...
    games: 150,
    avgElixir: 2.9,
    cards: ["Hog Rider", "Valkyrie", "Musketeer", "Cannon", "Fireball", "Log", "Ice Spirit", "Skeletons"],
  },
  {
    id: 2,
    name: "Golem Beatdown",
    ...
    games: 89,
    avgElixir: 4.2,
    cards: ["Golem", "Night Witch", "Baby Dragon", "Mega Minion", "Lightning", "Zap", "Tornado", "Lumberjack"],
  },
  {
    id: 3,
    name: "X-Bow Siege",
  ...
  },
  {
    ...
    games: 92,
    avgElixir: 3.1,
    cards: ["Miner", "Poison", "Valkyrie", "Bats", "Spear Goblins", "Ice Spirit", "Skeletons", "Inferno Tower"],
  },
  {
    id: 5,
    name: "Lava Hound",
    ...
    games: 74,
    avgElixir: 3.8,
    cards: ["Lava Hound", "Balloon", "Mega Minion", "Tombstone", "Arrows", "Zap", "Skeleton Army", "Minions"],
  },
  {
    id: 6,
    ...
    games: 103,
    avgElixir: 3.9,
    cards: ["P.E.K.K.A", "Battle Ram", "Bandit", "Electro Wizard", "Zap", "Poison", "Ghost", "Dark Prince"],
  },
];
