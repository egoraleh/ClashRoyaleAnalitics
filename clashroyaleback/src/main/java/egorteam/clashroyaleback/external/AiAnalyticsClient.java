...
public class AiAnalyticsClient {
    ...
    public record AiGenerateDeckRequest(String playerTag, Dtos.GenerateDeckRequest constraints,
                                        List<Dtos.Card> availableCards) {
    }
    ...
    public record AiCompareRequest(String playerTag, Dtos.DeckShort leftDeck, Dtos.DeckShort rightDeck,
                                   Dtos.CompareDecksRequest originalRequest) {
    }
