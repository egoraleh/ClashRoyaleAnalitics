...
const deckPerformance = [
  { name: "Hog Cycle", winRate: 68, games: 150, avgElixir: 2.9 },
  { name: "Golem Beatdown", winRate: 54, games: 89, avgElixir: 4.2 },
  { name: "X-Bow Siege", winRate: 62, games: 67, avgElixir: 3.3 },
];
        ...
        <div className="bg-card border border-border rounded-xl p-6 shadow-xl">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={statsData}>
              ...
              <YAxis stroke="#94a3b8" domain={[5000, 5800]} />
              <Tooltip
                contentStyle={{
