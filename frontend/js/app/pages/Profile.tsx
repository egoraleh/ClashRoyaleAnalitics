...
const favoriteCards = [
  { name: "Hog Rider", usage: 150, winRate: 68 },
  { name: "Valkyrie", usage: 142, winRate: 65 },
  { name: "Fireball", usage: 138, winRate: 64 },
  { name: "Musketeer", usage: 125, winRate: 67 },
  { name: "Log", usage: 118, winRate: 70 },
  { name: "Cannon", usage: 102, winRate: 62 },
];
              ...
              >
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <div className="flex-1">
                    <h3>{card.name}</h3>
                    <div className="text-sm text-muted-foreground">{card.usage} uses</div>
                  </div>
                </div>
                ...
                <div className="w-full bg-background rounded-full h-1.5 mt-2">
                  <div
                    className="bg-gradient-to-r from-[#6366f1] to-[#8b5cf6] h-1.5 rounded-full transition-all"
                    style={{ width: `${card.winRate}%` }}
                  />
                </div>
              </div>
            ))}
